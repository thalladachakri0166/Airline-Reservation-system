...
public class FlightController {
	...
	@Autowired
	private com.cmpe275.AirlineReservationSystem.repository.FlightRepository flightRepository;

	@RequestMapping(value = "/flights", method = RequestMethod.GET, produces = { "application/json", "application/xml" })
