...
public class ReservationController {
    ...
    @Autowired
    private com.cmpe275.AirlineReservationSystem.repository.ReservationRepository reservationRepository;

    @RequestMapping(value = "/reservations", method = RequestMethod.GET, produces = { "application/json", "application/xml" })
